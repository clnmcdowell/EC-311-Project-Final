...
HD_PWD='X:/Desktop/EC311Project/EC311Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Tennis.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Tennis.tcl -notrace

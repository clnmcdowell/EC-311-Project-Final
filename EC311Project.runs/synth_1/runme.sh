...
HD_PWD='X:/Desktop/EC311Project/EC311Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Tennis.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Tennis.tcl
